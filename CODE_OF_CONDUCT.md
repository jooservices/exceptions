...
`jooservices/exceptions` community a harassment-free experience for everyone,
...
This Code of Conduct applies within all community spaces for this repository and
when an individual is officially representing the project in public spaces.
Examples include using an official project email address, posting through an
...
Community Impact Guidelines may be used by maintainers in determining the
